      ...
      <section className={styles.section}>
        ...
        <div className={styles.sectionBody}>
          <div className={styles.row}>
            ...
            <ImageGallery
              images={[
                { src: 'https://picsum.photos/seed/gallery1/800/600', alt: 'Mountain landscape' },
                { src: 'https://picsum.photos/seed/gallery2/800/600', alt: 'Forest path' },
                { src: 'https://picsum.photos/seed/gallery3/800/600', alt: 'Ocean waves' },
                { src: 'https://picsum.photos/seed/gallery4/800/600', alt: 'City skyline' },
                { src: 'https://picsum.photos/seed/gallery5/800/600', alt: 'Desert dunes' },
              ]}
            />
          </div>
        </div>
